...
- `data/reference/historical/` – historical reference data. `staatsgrenzen.geojson`
  is the **active** "Grenzen 1800" layer (world borders ~1880–1900; styled by
  `qgis/styles/grenzen.qml`, filtered to AT-Hungary/Romania + Balkan neighbours via a
  subset string in `qgis_bootstrap.py`). `arcanum_clip.geojson` is the **cutline**
