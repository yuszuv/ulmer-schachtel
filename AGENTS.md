...
- **Generated vs. hand-maintained styles:** `poi_destinations.qml` and
  ...
  (base64-embeds SVG icons). `rail_lines.qml` and `info_markers.qml` are
  hand-maintained. Do not edit the generated files directly.
...
- **`.qgz` XML edits:** Jan edits `qgis/reiseplan.qgz` in QGIS directly for the
